    ...
    <div class="container">
        ...
        <div class="row">
            <form action="{{url('/submit-order')}}" method="post" class="form-horizontal">
                ...
                <input type="hidden" name="street_no" value="{{$shipping_address->street_no}}">
                <input type="hidden" name="district" value="{{$shipping_address->district}}">
                <input type="hidden" name="pincode" value="{{$shipping_address->pincode}}">
                <input type="hidden" name="prvince" value="{{$shipping_address->ptovince}}">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>{{$shipping_address->street_no}}</td>
                                <td>{{$shipping_address->district}}</td>
